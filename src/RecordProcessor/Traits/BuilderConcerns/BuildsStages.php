...
trait BuildsStages
{
    ...
    public function filterValidRecords(): static
    {
    ...
    public function downloadFileOutput($outputFilename = '', $deleteFileAfterDownload = false): static
    {
    ...
    public function logRecords($prefix = null): static
    {
    ...
    public function logInvalidRecords($prefix = 'INVALID'): static
    {
        $writer = new LogWriter($this->getLogger());
    ...
    public function echoRecords($prefix = null): static
    {
